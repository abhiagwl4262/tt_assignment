...
from utils.general import (LOGGER, Profile, check_img_size, check_requirements, colorstr,
...
def parse_opt():
    ...
    parser.add_argument('--output', type=str, default=ROOT / 'output', help='path to save model output')
